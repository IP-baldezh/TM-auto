...
export const ENTITIES: Record<EntityKey, EntityConfig> = {
  ...
  cars: {
    ...
    fields: [
      ...
      { name: 'reviewAuthor', label: 'Отзыв — имя клиента', type: 'text', placeholder: 'Иван, Москва', wide: true },
      { name: 'reviewText', label: 'Отзыв — текст', type: 'textarea', rows: 3, wide: true },
    ...
    schema: z.object({
      ...
      reviewAuthor: nullableText,
      reviewText: nullableText,
