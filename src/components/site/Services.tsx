...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Наш специалист на месте мониторит площадки, аукционы и дилерские центры за рубежом. Совместно выбираем автомобиль и проводим очную инспекцию перед покупкой.',
  },
  {
    num: '04',
    title: 'Доставка и таможня',
    desc: 'Организуем безопасную доставку из-за рубежа в Россию и берём на себя таможенное оформление, получение СБКТС и ЭПТС.',
  },
  {
    num: '05',
