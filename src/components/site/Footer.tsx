...
function AisisLogo() {
  return (
    <svg viewBox="0 0 146 33" role="img" aria-label="aisis" className="h-4 w-auto fill-current">
      ...
      <path className="fill-[#009C94]" d="M132.608 0H145.179V32.4676H132.608V26.7669H141.555L138.006 30.278V2.18968L141.555 5.70071H132.608V0Z" />
      <path className="fill-[#009C94]" d="M12.5718 0V5.70071H3.66205L7.17308 2.18968V30.278L3.66205 26.7669H12.5718V32.4676H0V0H12.5718Z" />
    </svg>
  );
}
