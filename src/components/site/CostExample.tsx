...
const EXAMPLES: CarExample[] = [
  {
    ...
    items: [
      { label: 'Стоимость авто за рубежом', sublabel: '126 000 юаней по курсу', amount: '≈ 1 680 000 ₽' },
  ...
  },
  {
    ...
    items: [
      { label: 'Стоимость авто за рубежом', sublabel: '329 800 юаней по курсу', amount: '≈ 4 450 000 ₽' },
  ...
  },
  {
    ...
    items: [
      { label: 'Стоимость авто за рубежом', sublabel: '189 800 юаней по курсу', amount: '≈ 2 530 000 ₽' },
  ...
  },
  {
    ...
    items: [
      { label: 'Стоимость авто за рубежом', sublabel: '21 500 000 вон по курсу', amount: '≈ 1 400 000 ₽' },
...
export function CostExample() {
  ...
  return (
    <Section id="cost-example" tone="paper" className="pb-8 pt-14 md:py-28 lg:py-32">
      <Container>
        {/* Заголовок */}
