...
export const DEFAULT_CARS = [
  {
    ...
    reviewText: 'Брал Golf 2025 под заказ — всё прошло быстро и чисто. Пригнали из Германии за 5 недель, документы в порядке, машина без пробега. Очень доволен.',
  ...
  },
  {
    ...
    reviewText: 'Coolray взял для жены — отличный выбор за свои деньги. ТМ Авто привезли из Китая, всё оформили под ключ. Ездим уже полгода, никаких проблем.',
  ...
  },
  {
    ...
    reviewText: 'Monjaro — это уровень. Полный привод, просторный салон, всё по цене ниже российских дилеров. Ребята провели инспекцию на заводе, отчёт с фото прислали до оплаты.',
  ...
  },
  {
    ...
    reviewText: 'Q3 из Германии — мечта стала реальностью. Всё оформили за 6 недель, растаможка, СБКТС — взяли на себя. Машина пришла идеальная, ни царапины.',
  ...
  },
  {
    ...
    reviewText: 'Tiguan R-Line 2025 — брал новый из Германии. Сэкономил около 400 000 относительно официалов. Команда на связи 24/7, всё чётко и в срок.',
  ...
  },
  {
    ...
    reviewText: 'Corolla из Японии с реальным пробегом и полной историей обслуживания. Проверили по всем базам, привезли быстро. Очень рада, что обратилась именно сюда.',
