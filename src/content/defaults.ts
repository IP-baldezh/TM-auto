...
export const DEFAULT_CARS = [
  {
    ...
    reviewText: 'Ребята нашли отличный вариант за 12 дней. Полный порядок с документами, привезли в срок. Очень доволен.',
    imageUrl: IMAGES.carQ5,
  ...
  },
  {
    ...
    savings: 120_000,
    description: null,
    reviewAuthor: 'Андрей, Москва',
    reviewText: 'Сомневался поначалу, но ТМ Авто провели всё чисто — осмотр, растаможка, доставка. BMW пришла в идеальном состоянии.',
    imageUrl: IMAGES.carBlue,
  ...
  },
  {
    ...
    savings: 60_000,
    description: null,
    reviewAuthor: 'Елена, Дзержинск',
    reviewText: 'Нашли Polo за 6 дней! Цена оказалась ниже, чем я ожидала. Все вопросы по оформлению взяли на себя.',
  ...
  },
  {
    ...
    savings: 240_000,
    description: null,
    reviewAuthor: 'Руслан, Казань',
    reviewText: 'Panamera — мечта. Думал, будет сложно с документами на такой автомобиль, но ТМ Авто сделали всё без проблем.',
    imageUrl: IMAGES.highway,
  ...
  },
  {
    ...
    savings: 150_000,
    description: null,
    reviewAuthor: 'Максим, Санкт-Петербург',
    reviewText: 'Мустанг из США — казалось, это нереально. Команда всё организовала: осмотр, доставку, СБКТС. Рекомендую.',
  ...
  },
  {
    ...
    savings: 310_000,
    description: null,
    reviewAuthor: 'Игорь, Нижегородская обл.',
    reviewText: 'Долго искали — зато нашли идеальный экземпляр. Сэкономили больше 300 000 ₽ относительно объявлений на рынке.',
...
export const DEFAULT_FAQ = [
  ...
  },
  {
    ...
    answer:
      'Из Китая — в среднем 4–8 недель с момента подбора автомобиля до получения в России. Из Кореи — 3–6 недель. Сроки зависят от маршрута доставки и скорости прохождения таможни. Точные сроки обсуждаем под конкретный автомобиль.',
    sortOrder: 4,
  },
  {
...
export const DEFAULT_SEO = {
  ...
  keywords:
    'авто под заказ из Китая, авто из Китая под ключ, авто под заказ из Кореи, авто из Кореи под ключ, растаможка авто из Китая, растаможка авто из Кореи, доставка авто из Китая и Кореи',
  ogTitle: 'Авто под заказ из Китая, Кореи и Европы — ТМ Авто',
  ogDescription:
    'Подбираем, проверяем на месте, растамаживаем и доставляем авто из Китая и Кореи. Таможня и СБКТС включены. Работаем по всей России.',
