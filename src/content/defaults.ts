...
export const DEFAULT_PROCESS = [
  { phase: 'Договор и подбор',      sortOrder: 0,  title: 'Подписываем договор',         text: 'Фиксируем ваши критерии: марку, модель, комплектацию и бюджет.',              detail: null, imageUrl: null },
  { phase: 'Договор и подбор',      sortOrder: 1,  title: 'Аванс',                        text: 'Резервируем место в поставке и приступаем к подбору.',                        detail: null, imageUrl: null },
  { phase: 'Договор и подбор',      sortOrder: 2,  title: 'Выбираете автомобиль',         text: 'Из актуального прайса — цвет кузова, салона и комплектация.',                 detail: null, imageUrl: null },
  { phase: 'Оплата и бронирование', sortOrder: 3,  title: 'Осмотр и бронирование',        text: 'Фото- и видеоотчёт с автомобилем. Оформляем бронь у экспортёра.',             detail: null, imageUrl: null },
  { phase: 'Оплата и бронирование', sortOrder: 4,  title: 'Оплата инвойса',               text: 'Переводите стоимость авто в юанях — займёт 5–10 минут.',                      detail: null, imageUrl: null },
  { phase: 'Оплата и бронирование', sortOrder: 5,  title: 'Деньги поступают экспортёру',  text: 'Обычно 2–3 рабочих дня. Сразу готовим экспортные документы.',                 detail: null, imageUrl: null },
  { phase: 'Логистика',             sortOrder: 6,  title: 'Оплата доставки',              text: 'Фиксированная стоимость логистики до границы с Россией.',                     detail: null, imageUrl: null },
  { phase: 'Логистика',             sortOrder: 7,  title: 'Везём автомобиль в Россию',    text: 'Маршрут: Китай → нейтральная зона → Казахстан → СВХ в РФ.',                   detail: null, imageUrl: null },
  { phase: 'Таможня и документы',   sortOrder: 8,  title: 'Таможенное оформление',        text: 'Берём на себя все процедуры растаможки.',                                     detail: null, imageUrl: null },
  { phase: 'Таможня и документы',   sortOrder: 9,  title: 'Оплата таможенной пошлины',    text: 'Выставляем квитанции — вы оплачиваете по фактическим ставкам.',               detail: null, imageUrl: null },
  { phase: 'Таможня и документы',   sortOrder: 10, title: 'Сертификация',                 text: 'Лаборатория, СБКТС и электронный ПТС — авто готово к регистрации.',           detail: null, imageUrl: null },
  { phase: 'Подготовка и выдача',   sortOrder: 11, title: 'Доставка до вашего города',    text: 'Отправляем автовозом или транспортной компанией.',                            detail: null, imageUrl: null },
  { phase: 'Подготовка и выдача',   sortOrder: 12, title: 'Мойка и подготовка',           text: 'Приводим автомобиль в порядок перед передачей.',                              detail: null, imageUrl: null },
  { phase: 'Подготовка и выдача',   sortOrder: 13, title: 'Передаём вам ключи',           text: 'Осматриваем вместе и подписываем акт приёма.',                                detail: null, imageUrl: null },
  { phase: 'Подготовка и выдача',   sortOrder: 14, title: 'ТО и допоборудование',         text: 'По желанию — сразу сделаем первое ТО и установим всё нужное.',                detail: null, imageUrl: null },
];
