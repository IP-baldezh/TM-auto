...
export const DEFAULT_FAQ = [
  {
    ...
    answer:
      'Работаем с двумя рынками — Китай и Корея. Из Китая привозим новые автомобили напрямую от производителей и дилеров: BYD, Chery, Geely, Mazda, Audi и другие. Из Кореи — автомобили с аукционов и от официальных дилеров: Hyundai, Kia, Genesis, SsangYong.',
    sortOrder: 0,
  },
  {
    question: 'Сколько стоит пригон автомобиля?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Все условия фиксируются в договоре с указанием конкретного автомобиля и итоговой суммы. Деньги за авто переводятся только после вашего одобрения результатов осмотра. Мы работаем с 2023 года и дорожим репутацией.',
    sortOrder: 5,
  },
  {
...
export const DEFAULT_SEO = {
  id: 'seo',
  title: 'Пригон авто из Китая и Кореи под ключ — ТМ Авто',
  description:
    'Подбор и пригон автомобилей из Китая и Кореи: предотгрузочная инспекция, таможня, СБКТС и доставка по России. Фиксированная цена в договоре.',
  h1: 'Пригон автомобилей из Китая и Кореи',
  keywords:
    'пригон авто из Китая, авто из Китая под ключ, пригон авто из Кореи, авто из Кореи под ключ, растаможка авто из Китая, растаможка авто из Кореи, доставка авто из Китая и Кореи',
  ogTitle: 'Пригон авто из Китая и Кореи под ключ — ТМ Авто',
  ogDescription:
